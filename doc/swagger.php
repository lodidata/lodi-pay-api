            ...
            'info' => [
                ...
                'description' => "1. 统一所有金额前端输入输出单位，均为分 （前端首页中奖金额、 提现金额、 钱包金额）  \n\t
                    ...
                    代码地址迁移列表：  \n\t
                        ...
                        '/message/status/delete.php' => '/user/message/delete.php' \n \t
                        ...
                        '/user/addbank/delete.php' => '/user/bank/delete.php' \n \t
                        ...
                        '/user/agent/market/delete.php' => '/user/agent/market/delete.php' \n \t
                        '/user/tree/login/post.php' => '/user/tree/login/post.php' \n \t
                        '/user/tree/loginwx/post.php' => '/user/tree/loginwx/post.php' \n \t
                        '/user/tree/logout/get.php' => '/user/tree/logout/get.php' \n \t
                        '/user/tree/get.php' => '/user/tree/get.php' \n \t
                        ...
                        '/user/checkmobile/get.php' => '/user/tree/register/checkmobile/get.php' \n \t
                        ...
                        '/user/newreg/get.php' => '/user/tree/register/config/get.php' \n \t
                        '/user/openverification/get.php' => '/user/safety/openverification/get.php' \n \t
                        '/user/password/patch.php' => '/user/tree/password/patch.php' \n \t
                        '/user/profile/get.php' => '/user/profile/get.php' \n \t
                        '/user/register/get.php' => '/user/tree/register/get.php' \n \t
                        '/user/register/post.php' => '/user/tree/register/post.php' \n \t
                        '/user/resetpwd/get.php' => '/user/tree/forget/get.php' \n \t
                        '/user/resetpwd/post.php' => '/user/tree/forget/post.php' \n \t
                        '/user/resetpwd/delete.php' => '/user/tree/forget/delete.php' \n \t
                        '/user/resetpwd/patch.php' => '/user/tree/forget/patch.php' \n \t
                        '/user/safety/get.php' => '/user/safety/get.php' \n \t
                        '/user/sendregmsg/post.php' => '/user/tree/register/mobliecode/post.php' \n \t
                        '/user/trytoplay/get.php' => '/user/tree/trytoplay/get.php' \n \t
                        '/user/trytoplay/post.php' => '/user/tree/trytoplay/post.php' \n \t
                        ...
                        '/user/withdrawpwd/delete.php' => '/user/safety/withdrawpwd/delete.php' \n \t
                        ...
                        '/wallet/recharge/offlines/delete.php' => '/user/wallet/recharge/offlines/delete.php' \n \t
                        '/wallet/recharge/onlines/get.php' => '/user/wallet/recharge/onlines/get.php' \n \t
                        '/wallet/recharge/onlines/delete.php' => '/user/wallet/recharge/onlines/delete.php' \n \t
                        '/wallet/recovery/get.php' => '/user/wallet/exchange/recovery/get.php' \n \t
                        '/wallet/withdraw/get.php' => '/user/wallet/withdraw/get.php' \n \t
                        '/wallet/withdraw/delete.php' => '/user/wallet/withdraw/delete.php' \n \t
                       ...
                       \n \t  \n \t
                        ...
                        '/service/handle/delete.php' => '/service/handle/delete.php' \n \t
                    ...
                    '/lottery/play/pusher/io/tree/get.php', // 删除    \n\t
                    '/lottery/play/pusher/io/info/get.php', // 删除 合并到start/config/get.php    \n\t
                    '/lottery/play/pusher/io/publish/post.php', // 删除 合并到全局消息发送接口    \n\t
                    '/user/login/post.php', // 合并至 user/tree/login/post.php    \n\t
                    '/user/logout/get.php', // 合并至 user/tree/logout/get.php    \n\t
