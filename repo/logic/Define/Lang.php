...
class Lang
{
     ...
     * @return $this
     */
    public function set($state, array $stateParams = [], array $data = [], $attributes = null): Lang
    {
    ...
    {
        $path = $this->getLangDirPath();
        $langDirArr = scandir($path);
    ...
    {
        $path = $this->getLangDirPath();
        $filesDir = $path . $this->range . DIRECTORY_SEPARATOR;
     ...
     */
    public function text(string $key, array $params = [])
    {
    ...
    private function getLangDirPath(): string
    {
        return __DIR__ . $this->langDirPath;
    }
}